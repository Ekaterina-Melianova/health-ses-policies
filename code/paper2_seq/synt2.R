...
controls_constrained_rest_free = '
...
'
controls_constrained_rest_free_fit_dep_1 = sem(controls_constrained_rest_free,
                         data = df_lv_1, 
                         estimator = "mlr",
                         orthogonal = T, 
                         cluster = 'LAD21CD',
...
#current time
Sys.time()
anova(all_free_fit_dep_1, controls_constrained_rest_free_fit_dep_1)

#setwd to the output folder
setwd('C:/Users/ru21406/YandexDisk/PhD Research/health-ses-policies2/output/paper2')
saveRDS(controls_constrained_rest_free_fit_dep_1, "controls_constrained_rest_free_fit_dep_1.rds")
