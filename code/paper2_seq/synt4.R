...
covmeans_constrained_rest_free = '
...
'
covmeans_constrained_rest_free_fit_dep_1 = sem(covmeans_constrained_rest_free,
                                               data = df_lv_1, 
                                               estimator = "mlr",
                                               orthogonal = T, 
                                               cluster = 'LAD21CD',
...
#current time
Sys.time()
anova(covmeans_constrained_rest_free_fit_dep_1, growth_constrained_rest_free_fit_dep_1)
