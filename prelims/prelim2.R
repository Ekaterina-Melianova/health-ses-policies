...
sum(unlist(lapply(seq_along(list_df_), function(x){
  length(list_df[[x]])
  })
...
writexl::write_xlsx(policy_names_raw, 
                    'C:/Users/ru21406/YandexDisk/PhD Research/health-ses-policies/output/policy_names_raw.xlsx')
